...
public class ComisionConstants {
    ...
    public static final String COMISIONES_CALCULADAS_QUERY = "SELECT v FROM VwComisioneCalculada v WHERE CONCAT(v.idEstadoCuenta,'') LIKE :"+ID_ESTADO_CUENTA_PARAM+" AND v.pagoconcepto LIKE :"+PAGO_CONCEPTO_PARAM;
}
